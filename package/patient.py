...
class Patients(Resource):
    ...
    def post(self):
        ...
        conn.commit()
        dic = {"id":patientInput['pat_id'],"first_name":pat_first_name,"last_name":pat_last_name,"insurance":pat_insurance_no,"phone":pat_ph_no,"address":pat_address}
        col.insert_one(dic)
        print(patientInput)
        return patientInput
...
class Patient(Resource):
    ...
    def put(self,id):
        ...
        conn.commit()
        myquery = { "id": id }
        newvalues = { "$set": {"id":id,"first_name":pat_first_name,"last_name":pat_last_name,"insurance":pat_insurance_no,"phone":pat_ph_no,"address":pat_address} }
